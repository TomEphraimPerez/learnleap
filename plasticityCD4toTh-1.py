...
Pt = {'Tfh': {'Calories': 100, 'attoamps': 3, 'ACTivation': 1, 'EXPansion': 22,
                    'DIFFerentiation': 2, 'Expression': 7, 'Plasticity': 2.5, 'Units': 'continuous'},
        'Th9': {'Calories': 140, 'attoamps': 17, 'ACTivation': 9, 'EXPansion': 3,
                    'DIFFerentiation': 2, 'Expression': 2, 'Plasticity': 4.0, 'Units': 'continuous'},
        'Th2': {'Calories': 90, 'attoamps': 1, 'ACTivation': 0, 'EXPansion': 23, 'DIFFerentiation': 3,
                    'Expression': 10, 'Plasticity': 1.0, 'Units': 'discrete'},
        'iTreg': {'Calories': 150, 'attoamps': 9, 'ACTivation': 0, 'EXPansion': 25, 'DIFFerentiation': 4,
                    'Expression': 3, 'Plasticity': 1.3, 'Units': 'continuous'},
        'Tr1': {'Calories': 270, 'attoamps': 9, 'ACTivation': 3, 'EXPansion': 50, 'DIFFerentiation': 3,
                    'Expression': 5, 'Plasticity': 0.25, 'Units': 'continuous'},
        'Th22': {'Calories': 300, 'attoamps': 4, 'ACTivation': 30, 'EXPansion': 20, 'DIFFerentiation': 14,
                    'Expression': 5, 'Plasticity': 2.0, 'Units': 'discrete'},
        'Th17': {'Calories': 123, 'attoamps': 4, 'ACTivation': 30, 'EXPansion': 20, 'DIFFerentiation': 14,
                    'Expression': 5, 'Plasticity': 2.0, 'Units': 'discrete'},
        'Th1': {'Calories': 456, 'attoamps': 5, 'ACTivation': 31, 'EXPansion': 21, 'DIFFerentiation': 15,
...
for ind, Robustness in enumerate(Pt.keys()):
    ub = max_calories / Pt[Robustness]["Calories"] # upper bnd is 20 portions, 2000/100 for Tfh below
